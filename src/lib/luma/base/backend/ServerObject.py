...
class ServerObject(object):
    ...
    def __repr__(self):
        ...
        finalString.append(unicode(self.getName()))
        finalString.append(unicode("\nHost: "))
        finalString.append(unicode(self.getHostname()))
        finalString.append(unicode("\nPort: "))
        finalString.append(unicode(self.getPort()))
        finalString.append(unicode("\nBind anonymously: "))
        finalString.append(unicode(self.getBindAnon()))
        finalString.append(unicode("\nBase DN: "))
        map(lambda x: finalString.append(unicode(x) + u", "), self.getBaseDN())
        finalString.append(unicode("\nCurrent Base: "))
        finalString.append(unicode(self.getCurrentBase()))
        finalString.append(unicode("\nBind DN: "))
        finalString.append(unicode(self.getBindDN()))
        finalString.append(unicode("\nBind Password: "))
        finalString.append(unicode(self.getBindPassword()))
        finalString.append(unicode("\nEncryption method: "))
        finalString.append(unicode(self.getEncryptionMethod()))
        finalString.append(unicode("\nAuthentification method: "))
        finalString.append(unicode(self.getAuthMethod()))
        finalString.append(unicode("\nUse Client certificate: "))
        finalString.append(unicode(self.getUseCertificate()))
        finalString.append(unicode("\nClient certificate file: "))
        finalString.append(unicode(self.getClientCertFile()))
        finalString.append(unicode("\nClient certificate keyfile: "))
        finalString.append(unicode(self.getClientCertKeyfile()))
        finalString.append(unicode("\nCheck server certificate: "))
        finalString.append(unicode(self.getCheckServerCertificate()))
        finalString.append(unicode("\n"))
