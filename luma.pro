...
FORMS += resources/forms/plugins/browser_plugin\AddAttributeWizardDesign.ui
FORMS += resources/forms/plugins/browser_plugin\BinaryEditorDesign.ui
...
FORMS += resources/forms/plugins/browser_plugin\NewEntryDialogDesign.ui
FORMS += resources/forms/plugins/browser_plugin\PasswordEditorDesign.ui
FORMS += resources/forms/plugins/browser_plugin\RdnEditorDesign.ui
FORMS += resources/forms/plugins/browser_plugin\StandardEditorDesign.ui
...
FORMS += resources/forms/plugins/template\2AddObjectclassDialogDesign.ui
FORMS += resources/forms/plugins/template\2TemplateWidgetDesign.ui
...
SOURCES += luma/plugins/browser_plugin\AddAttributeWizard.py
...
SOURCES += luma/plugins/browser_plugin/editors\BinaryEditor.py
SOURCES += luma/plugins/browser_plugin/editors\EditorFactory.py
SOURCES += luma/plugins/browser_plugin/editors\PasswordEditor.py
SOURCES += luma/plugins/browser_plugin/editors\RdnEditor.py
SOURCES += luma/plugins/browser_plugin/editors\StandardEditor.py
SOURCES += luma/plugins/browser_plugin/gui\AddAttributeWizardDesign.py
SOURCES += luma/plugins/browser_plugin/gui\BinaryEditorDesign.py
SOURCES += luma/plugins/browser_plugin/gui\BrowserDialogs.py
...
SOURCES += luma/plugins/browser_plugin/gui\NewEntryDialogDesign.py
SOURCES += luma/plugins/browser_plugin/gui\PasswordEditorDesign.py
SOURCES += luma/plugins/browser_plugin/gui\RdnEditorDesign.py
SOURCES += luma/plugins/browser_plugin/gui\StandardEditorDesign.py
...
SOURCES += luma/plugins/browser_plugin/utils\mkpasswd.py
...
SOURCES += luma/plugins/template/gui\2AddObjectclassDialogDesign.py
SOURCES += luma/plugins/template/gui\2TemplateWidgetDesign.py
...
SOURCES += luma/plugins/tetris\Tetris.py
