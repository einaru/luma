...
class Ui_ServerDialogDesign(object):
    ...
    def setupUi(self, ServerDialogDesign):
        ...
        self.baseDNListWidget = QtGui.QListWidget(self.tab)
        self.baseDNListWidget.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)
        self.baseDNListWidget.setSelectionRectVisible(True)
        self.baseDNListWidget.setObjectName("baseDNListWidget")
        self.gridLayout_6.addWidget(self.baseDNListWidget, 8, 1, 1, 4)
        ...
        QtCore.QObject.connect(self.baseBox, QtCore.SIGNAL("toggled(bool)"), self.addBaseDNButton.setDisabled)
        QtCore.QObject.connect(self.baseBox, QtCore.SIGNAL("toggled(bool)"), self.deleteBaseDNButton.setDisabled)
        QtCore.QObject.connect(self.baseBox, QtCore.SIGNAL("toggled(bool)"), self.baseEdit.setDisabled)
        QtCore.QObject.connect(self.baseBox, QtCore.SIGNAL("toggled(bool)"), self.baseDNListWidget.setDisabled)
        QtCore.QObject.connect(self.baseEdit, QtCore.SIGNAL("returnPressed()"), ServerDialogDesign.addBaseDN)
        ...
        ServerDialogDesign.setTabOrder(self.deleteButton, self.tabWidget)
        ServerDialogDesign.setTabOrder(self.tabWidget, self.hostLineEdit)
    ...
    def retranslateUi(self, ServerDialogDesign):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtGui.QApplication.translate("ServerDialogDesign", "Network", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab1), QtGui.QApplication.translate("ServerDialogDesign", "Authentification", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("ServerDialogDesign", "Security", None, QtGui.QApplication.UnicodeUTF8))
