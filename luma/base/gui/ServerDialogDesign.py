...
class Ui_ServerDialogDesign(object):
    def setupUi(self, ServerDialogDesign):
        ...
        QtCore.QObject.connect(self.bindAnonBox, QtCore.SIGNAL("toggled(bool)"), self.methodBox.setDisabled)
        QtCore.QObject.connect(self.bindAnonBox, QtCore.SIGNAL("toggled(bool)"), self.bindLineEdit.setDisabled)
        QtCore.QObject.connect(self.bindAnonBox, QtCore.SIGNAL("toggled(bool)"), self.passwordLineEdit.setDisabled)
