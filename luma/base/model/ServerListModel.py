...
class ServerListModel(QAbstractTableModel):
    """
    Defines a tablemodel where rows are different servers and
    columns are the properties of it
    """

    def __init__(self, ServerList, parent=None):
        super(ServerListModel, self).__init__(parent)
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        @return:
            True if the insex is valid, False otherwise
        """
        ...
        # Find the serverobject from the list of server objects,
        # update the correct field (given the column) with the given data, and
        # emit a signal to let other views know the underlying data is changed.
    ...
    def columnCount(self, parent):
        """
        @return:
            The number of different settings for the servers
        """
    ...
    def data(self, index, role=Qt.DisplayRole):
        """
        Handles getting the correct data from the ServerObjects
        
        @return:
            The correct data from the ServerObjects
        """
        ...
        if role == Qt.DisplayRole or role == Qt.EditRole:
            ...
            # correct painting/displaying of it is done by
            # a delegate if needed
