...
# Form implementation generated from reading ui file '/home/einar/Desktop/luma-release-tagging/resources/forms/plugins/template/AddAttributeDialogDesign.ui'
#
...
class Ui_AddAttributeDialog(object):
    def setupUi(self, AddAttributeDialog):
        AddAttributeDialog.setObjectName("AddAttributeDialog")
        ...
        QtCore.QObject.connect(self.pushButtonCancel, QtCore.SIGNAL("clicked()"), AddAttributeDialog.reject)
        QtCore.QObject.connect(self.pushButtonOk, QtCore.SIGNAL("clicked()"), AddAttributeDialog.accept)
