...
# Form implementation generated from reading ui file '/mnt/debris/devel/repo/git/luma-fixes/resources/forms/plugins/template/DeleteObjectclassDialogDesign.ui'
#
