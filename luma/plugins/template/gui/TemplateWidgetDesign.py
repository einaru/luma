...
# Form implementation generated from reading ui file '/home/einar/Desktop/luma-release-tagging/resources/forms/plugins/template/TemplateWidgetDesign.ui'
#
...
class Ui_TemplateWidget(object):
    def setupUi(self, TemplateWidget):
        ...
        self.pushButtonTemplatesSave.setObjectName("pushButtonTemplatesSave")
        ...
        self.pushButtonTemplatesAdd.setObjectName("pushButtonTemplatesAdd")
        ...
        self.listViewTemplates.setObjectName("listViewTemplates")
        ...
        self.pushButtonTemplatesDelete.setObjectName("pushButtonTemplatesDelete")
        ...
        self.pushButtonTemplatesDuplicate.setObjectName("pushButtonTemplatesDuplicate")
        ...
        self.groupBoxObjectclasses.setObjectName("groupBoxObjectclasses")
        ...
        self.pushButtonObjectclassesAdd.setObjectName("pushButtonObjectclassesAdd")
        ...
        self.listViewObjectclasses.setObjectName("listViewObjectclasses")
        ...
        self.pushButtonObjectclassesDelete.setObjectName("pushButtonObjectclassesDelete")
        ...
        self.tableViewAttributes.setObjectName("tableViewAttributes")
        ...
        self.pushButtonAttributesAdd.setObjectName("pushButtonAttributesAdd")
        ...
        self.pushButtonAttributesDelete.setObjectName("pushButtonAttributesDelete")
        ...
        QtCore.QObject.connect(self.pushButtonAttributesAdd, QtCore.SIGNAL("clicked()"), TemplateWidget.addAttribute)
        QtCore.QObject.connect(self.pushButtonObjectclassesAdd, QtCore.SIGNAL("clicked()"), TemplateWidget.addObjectclass)
        QtCore.QObject.connect(self.pushButtonTemplatesAdd, QtCore.SIGNAL("clicked()"), TemplateWidget.addTemplate)
        QtCore.QObject.connect(self.pushButtonAttributesDelete, QtCore.SIGNAL("clicked()"), TemplateWidget.deleteAttributes)
        QtCore.QObject.connect(self.pushButtonObjectclassesDelete, QtCore.SIGNAL("clicked()"), TemplateWidget.deleteObjectclass)
        QtCore.QObject.connect(self.pushButtonTemplatesDelete, QtCore.SIGNAL("clicked()"), TemplateWidget.deleteTemplate)
        QtCore.QObject.connect(self.pushButtonTemplatesDuplicate, QtCore.SIGNAL("clicked()"), TemplateWidget.duplicateTemplate)
        QtCore.QObject.connect(self.pushButtonTemplatesSave, QtCore.SIGNAL("clicked()"), TemplateWidget.saveTemplate)
